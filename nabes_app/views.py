...
class IndexView(ListView):
    ...
    def get_context_data(self, **kwargs):
        ...
        context['top_post_list'] = PublicPost.objects.filter(priority='Top')[:1]
        context['middle_post_list'] = PublicPost.objects.filter(priority='Middle')[:1]
        context['bottom_post_list'] = PublicPost.objects.filter(priority='Bottom')[:1]
        return context
